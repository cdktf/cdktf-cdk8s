...
export class UpgradeCDKTF {
  constructor(project: javascript.NodeProject) {
    ...
    workflow.on({
      schedule: [{ cron: "55 */6 * * *" }], // Runs four times a day
          ...
          },
          {
            ...
            with: {
              ...
              body: [
                ...
                " ",
                "- [ ] Update `@cdktf/provider-kubernetes` to a version compatible with `cdktf@${{ steps.latest_version.outputs.value }}` [here](https://github.com/cdktf/cdktf-cdk8s/blob/4d23de9f0dadddb922bf1c44079f08856491f11b/.projenrc.ts#L67). Look up the version [here](https://github.com/cdktf/cdktf-provider-kubernetes/releases/).",
                "- [ ] Run `npx projen`",
                " ",
